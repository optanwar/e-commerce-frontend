...
import { Facebook, Instagram, Twitter, Mail, Phone, MapPin, Candy } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed text-white/90 font-body">
            Nutritious & delicious gummies crafted for happy kids and happier parents.
            Pediatrician-approved and loved by families.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm font-body">
            ...
            <li>
              <Link to="/contact-us" className="hover:text-accent transition">
                Contact
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <div className="space-y-2 text-sm text-white/90 font-body">
            <div className="flex items-center gap-2">
              <Mail size={16} />
              <a href="mailto:support@yummygummies.com" className="underline hover:text-accent">
