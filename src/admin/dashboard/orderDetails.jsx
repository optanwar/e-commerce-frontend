  ...
  return (
    <div className="p-6 space-y-10">
      ...
      <div className="bg-white rounded-xl shadow-soft p-6 flex flex-col md:flex-row justify-between items-start md:items-center">
        <div>
          ...
          <p className="mt-1 text-sm">
            Status:{' '}
            <span
              className={`capitalize font-semibold ${orderDetails.orderStatus === 'Delivered' ? 'text-green-600' : 'text-yellow-600'}`}
            >
      ...
      <div className="bg-white rounded-xl shadow-soft p-6">
        ...
        <p>
          <span className="font-semibold">Name:</span> {orderDetails.shippingInfo.name}
        </p>
        <p>
        ...
        <p>
          <span className="font-semibold">Phone:</span> {orderDetails.shippingInfo.phoneNo}
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-soft p-6">
        ...
        <p>
          ...
          {orderDetails.paymentInfo.method || 'Online'}
        </p>
        <p>
          <span className="font-semibold">Status:</span>{' '}
          <span
            className={`font-semibold ${orderDetails.paymentInfo.status === 'succeeded' ? 'text-green-600' : 'text-red-500'}`}
          >
