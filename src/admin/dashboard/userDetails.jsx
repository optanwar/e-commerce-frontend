...
import { Ban, CalendarDays, CheckCircle2, Fingerprint, Mail, Phone, ShieldCheck, ShoppingCart, Star, User, UserCog } from 'lucide-react';
          ...
          <div className="space-y-4">
            {orders.map((order) => (
              <div key={order._id} className="border p-4 rounded-md">
                <p className="text-sm text-gray-800">Order ID: <span className="font-mono">{order._id}</span></p>
