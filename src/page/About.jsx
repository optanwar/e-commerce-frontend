  ...
  return (
    <main className="bg-lightBg min-h-screen text-darkText">
      ...
      >
        ...
        <div className="relative max-w-xl text-center md:text-left z-10">
          ...
          <p className="text-white text-lg sm:text-xl leading-relaxed max-w-md mx-auto md:mx-0">
            Healthy, delicious gummies specially made for kids — backed by parents and pediatricians across the USA.
          </p>
        </div>
      ...
      <section className="max-w-6xl mx-auto py-16 px-6 md:px-12 lg:px-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        />
        <div>
          <h2 className="text-3xl font-heading text-accent mb-6 font-semibold">
            Our Story
          </h2>
          <p className="text-gray-700 leading-relaxed text-lg md:text-xl">
            Founded by parents who struggled to find supplements their kids would actually enjoy, YummyGummies was born to bridge the gap between nutrition and taste.
            We create natural, no-added-sugar gummies, backed by pediatricians, designed to make vitamin time fun and worry-free.
            Our passion is fueling healthy habits for kids across the USA — one gummy at a time.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto py-16 px-6 md:px-12 lg:px-20 grid md:grid-cols-2 gap-12 items-center bg-primary bg-opacity-10 rounded-xl shadow-md">
        <div>
          <h2 className="text-3xl font-heading text-primary mb-6 font-semibold">
            Our Mission
          </h2>
          <p className="text-primary text-lg leading-relaxed">
            We’re committed to nurturing happy, healthy children by making wellness enjoyable and accessible for families everywhere. 
            Using only premium, transparent ingredients and pediatrician-approved formulas, we want every child to thrive.
          </p>
        </div>
        <img
